...
HX_LOCAL_STACK_FRAME(_hx_pos_a2b9229e56451ffa_205_fold,"Lambda","fold",0x9b8816a8,"Lambda.fold","/usr/local/lib/haxe/std/Lambda.hx",205,0xf61dfe9a)
...
bool Lambda_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Lambda_obj::fold( ::Dynamic it, ::Dynamic f, ::Dynamic first){
            	HX_STACKFRAME(&_hx_pos_a2b9229e56451ffa_205_fold)
HXLINE( 206)		{
HXLINE( 206)			 ::Dynamic x = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 206)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 206)				 ::Dynamic x1 = x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 207)				first = f(x1,first);
            			}
            		}
